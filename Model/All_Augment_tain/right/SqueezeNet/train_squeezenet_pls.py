...
def run_pipeline():
    ...
    train_path = '../ALL_Right_train_coef_features.csv'
    test_path = '../ALL_Right_test_coef_features.csv'
    if not os.path.exists(train_path):
        train_path = os.path.abspath(os.path.join(script_dir, '..', '..', '..', 'Output_Dataset', 'ALL_Right_train_coef_features.csv'))
    if not os.path.exists(test_path):
        test_path = os.path.abspath(os.path.join(script_dir, '..', '..', '..', 'Output_Dataset', 'ALL_Right_test_coef_features.csv'))
