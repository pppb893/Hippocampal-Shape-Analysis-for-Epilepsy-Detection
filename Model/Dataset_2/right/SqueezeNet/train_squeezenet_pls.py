...
def run_pipeline():
    ...
    train_path = '../Ds005602_Right_train_balanced_coef_features.csv'
    test_path = '../Ds005602_Right_test_coef_features.csv'
    if not os.path.exists(train_path):
        train_path = os.path.abspath(os.path.join(script_dir, '..', '..', '..', 'Output_Dataset', 'Ds005602_Right_train_balanced_coef_features.csv'))
